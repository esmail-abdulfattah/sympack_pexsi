    ...
    inline void symPACKMatrixMeta<T>::getLColRowCount(SparseMatrixGraph & sgraph, std::vector<Int> & cc, std::vector<Int> & rc){
      ...
      if(this->iam==0){
        ...
        for(Idx lownbr = 1; lownbr<=size; ++lownbr){
          ...
          Idx ifdesc = fdesc[lownbr];
          //if(lownbr==1){
          //  std::cout << "fdesc[lownbr]:  " << fdesc[lownbr] << std::endl;
          //  std::cout << "lownbr:  " << lownbr << std::endl;
          //
          //}
          ...
          //if(lownbr==1){
          //  std::cout << "this->Order_.perm[lownbr-1]:  " << this->Order_.perm[lownbr-1] << std::endl;
          //  std::cout << "oldnbr:  " << oldnbr << std::endl;

          //}
          Ptr jstrt = sgraph.colptr[oldnbr-1];
          Ptr jstop = sgraph.colptr[oldnbr] - 1;
          //if(lownbr==1) std::cout << "sgraph.rowind[j-1]: " << jstrt-1 << " "  << sgraph.rowind[jstrt-1] << std::endl;
